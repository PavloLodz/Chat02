Sure — here is the updated **`.junie/guidelines.md`** content with the security roles and Spring Security conventions integrated.
...
If you want, I can also **tighten the security section further** so it reads more like a house style guide and less like general advice.
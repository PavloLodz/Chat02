...
Create an abstract base class `AbstractServiceIntegrationTest` in `src/test/java/${BASE_PACKAGE}/service/base/`:
...
Create an abstract base class `AbstractControllerIntegrationTest` in `src/test/java/${BASE_PACKAGE}/controller/`:
